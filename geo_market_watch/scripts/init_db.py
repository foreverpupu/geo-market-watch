#!/usr/bin/env python3
"""
Geo Market Watch — Initialize Database CLI
...
from geo_market_watch.database import init_database
...
Examples:
  gmw-init-db --db data/geo_alpha.db
    ...
    try:
        ...
        print("  Tables created: events, sources, indicators, flags, notifications, watchlist")
        return 0
