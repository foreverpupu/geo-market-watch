#!/usr/bin/env python3
"""
Geo Market Watch — Query Database CLI
...
from geo_market_watch.database import connect_db, get_stats, search_events
from geo_market_watch.dashboard_views import get_closed_ideas, get_tracked_ideas
from geo_market_watch.export_layer import build_idea_performance_view, build_performance_summary_view
...
Examples:
  ...
  gmw-query --db data/geo_alpha.db --stats
    ...
    if not Path(args.db).exists():
        ...
        print("  Run: gmw-init-db --db " + args.db)
        return 1
