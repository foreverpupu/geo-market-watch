...
- regional escalation with cross-market spillover
...
Without invalidation conditions, the output becomes narrative rather than research discipline.
...
- exchange notices
- ETF issuer pages
- official route or port authority notices
...
- a company reported exposure to a region
...
- "collapse", "historic", "apocalyptic", or similar framing without testable variables
...
- refining or processing dependencies
- alternative routes or backup capacity
...
The workflow must preserve uncertainty when the evidence does not justify certainty.
...
- strategic route reopens sustainably
- policy action caps the shock
...
- the output is useful for discussion, sharing, and follow-up monitoring
...
Use it as a disciplined research workflow, not as a substitute for judgment.
