...
- This repository does **not** provide any **investment advice** or any guarantee of financial returns.

## No Warranty

This repository is provided **as-is**, without any warranties or guarantees. The authors do not take any responsibility for any **financial**, **commercial**, or **personal** consequences resulting from the use of the material here, including but not limited to:

- The application of methods in financial markets
- Any trading decisions made using this repository
...
You **may not** use this repository for any **commercial** purpose, including but not limited to:
- Developing or offering services that charge users for access to this repository or its contents
- Reselling, licensing, or incorporating this repository into commercial software or products

For any use outside the scope of these terms, please contact the repository owner for prior written permission.
